                ...
                <form class="w-100 text-primary fw-bolder mr-3 mt-3">
                    ...
                    <div class="input-group justify-content-end">
                        <div class="form-floating g-0 w-50">
                            <input type="email" name="randonneeRecherche" id="randonneeRecherche" class="form-control" placeholder="Adresse E-Mail">
                            <label for="randonneeRecherche">Rechercher</label>
                        </div>
                        <button type="button" class="btn btn-success" onclick="researchProg()" id="buttonSearch">
