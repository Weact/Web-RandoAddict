<!--/*******************************************************************************\
* Fichier       : /HTML/Structure/HeaderAdmin.html
*
...
\*******************************************************************************/
\*******************************************************************************/
* TODO          : ADD PROFILE DROPDOWN BUTTON WITH ADDITIONALS OPTIONS         *-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
        <div class="container-fluid align-items-end">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <form class="w-100 text-primary fw-bolder mr-3 mt-3">
                    <div class="d-flex text-dark align-items-center justify-content-end">
                        <i class="bi bi-person-circle fs-1 me-3"></i>
                        <span id="session_username" class="fw-bolder fs-5 ">AdminPlaceholder</span>
                    ...
                    <div class="input-group justify-content-end">
                        <div class="form-floating g-0 w-50">
                            <input type="email" name="randonneeRecherche" id="randonneeRecherche" class="form-control" placeholder="Rechercher">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item text-left m-2 border-bottom border-2 border-primary rounded-pill nav-custom-link">
                        <a class="nav-link fw-bolder p-2 text-primary fs-5 goToMyRando" aria-current="page" href="#">Mes Randonnées</a>
                    </li>
                    <li class="nav-item text-left m-2 border-bottom border-2 border-primary rounded-pill nav-custom-link">
                        <a class="nav-link fw-bolder p-2 text-primary fs-5 goToAdmin" href="#">Espace Administrateur</a>
                    </li>
                </ul>

                <button class="btn btn-primary fw-bolder text-uppercase me-2" value="Connexion" hidden>Connexion</button>
                <button class="btn btn-primary fw-bolder text-uppercase" value="Inscription" hidden>Inscription</button>
