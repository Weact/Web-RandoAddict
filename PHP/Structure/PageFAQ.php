    ...
    <div class="accordion w-50" id="accordionExample">
      ...
      <div class="accordion-item">
        ...
        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body text-dark">Sed natus perferendis hic perspiciatis reprehenderit sed nisi quia sit maiores sapiente! Non quaerat velit eos voluptas quis ex reprehenderit nihil est velit quisquam et corporis rerum qui explicabo veniam 33 perferendis ullam. Non voluptate distinctio ut iure modi At laudantium corporis aut facere Quis ut totam delectus.</div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body text-dark">Eum sint maiores ex odio tempora est porro aperiam qui culpa quaerat in illum autem. At vitae amet qui numquam doloribus ut delectus repellat sed harum libero qui rerum sapiente. In molestiae internos sit harum enim qui dolor accusamus.</div>
        </div>
      </div>
